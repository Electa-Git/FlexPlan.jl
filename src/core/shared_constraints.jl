...
function constraint_power_balance_acne_dcne_flex(pm::_PM.AbstractWModels, n::Int, i::Int, bus_arcs, bus_arcs_ne, bus_arcs_dc, bus_gens, bus_convs_ac, bus_convs_ac_ne, bus_loads, bus_shunts, bus_storage, bus_storage_ne, pd, qd, gs, bs)
    p                = _PM.var(pm, n, :p)
    q                = _PM.var(pm, n, :q)
    p_ne             = _PM.var(pm, n, :p_ne)
    q_ne             = _PM.var(pm, n, :q_ne)
