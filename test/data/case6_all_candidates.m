...
%% storage data
%column_names%   storage_bus ps qs energy  energy_rating charge_rating  discharge_rating  charge_efficiency  discharge_efficiency  thermal_rating  qmin  qmax  r  x  p_loss  q_loss  status eq_cost inst_cost env_cost max_energy_absorption stationary_energy_inflow stationary_energy_outflow discharge_rate
mpc.ne_storage = [
     2   0.0     0.0     0.0     1000.0  200.0   250.0   0.9     0.9     250     -50.0   70.0    0.1     0.0     0.0     0.0      1     2.5     0.5     1 2400 0 0 0.001;
...
mpc.load_extra = [
1 100 1 0 0.3 0 0.3 0 2 2 0.1 0.00 0.00 10 0.0 1 0.5;
2 100 1 0 0.3 0 0.3 0 2 2 0.1 0.00 0.00 10 0.0 1 0.5;
3 100 1 0 0.3 0 0.3 0 2 2 0.1 0.00 0.00 10 0.0 1 0.5;
4 100 1 0 0.3 0 0.3 0 2 2 0.1 0.00 0.00 10 0.0 1 0.5;
