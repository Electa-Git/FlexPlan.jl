...
number_of_hours = 1000 # Number of time points
...
data, loadprofile, genprofile = _FP.create_profile_data_italy(data, start_hour, number_of_hours) # create laod and generation profiles
