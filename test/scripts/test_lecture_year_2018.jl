...
file = "./test/data/case6_stoch.m"   #Input case, in matpower m-file format: Here 6bus case with candidate AC, DC lines and candidate storage
...
scenario["sc_years"]["1"]["year"] = 2018
scenario["sc_years"]["1"]["start"] = 1514764800000   # 01.01.2018:00:00 in epoch time  
...
# change generation locations
genprofile[1,:] = genprofile[1,:] * 1.5
genprofile[2,:] = genprofile[2,:] * 1.5
genprofile[5,:] = genprofile[5,:] * 0.5
genprofile[6,:] = genprofile[6,:] * 0.5
...
plot_filename = join(["./test/data/output_files/lec_2018_","$number_of_hours",".kml"])
...
Plots.savefig(p, join(["profile_2018_","$number_of_hours","_hours"]))