...
genprofile[1,:] = genprofile[1,:] * 0.8
genprofile[2,:] = genprofile[2,:] * 0.8
genprofile[5,:] = genprofile[5,:] * 2
genprofile[6,:] = genprofile[6,:] * 2
...
plot_filename = join(["./test/data/output_files/lec_2019_","$number_of_hours",".kml"])
...
Plots.savefig(p,join(["profile_2019_","$number_of_hours","_hours"]))