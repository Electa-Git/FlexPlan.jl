...
cbc = JuMP.with_optimizer(Cbc.Optimizer, tol=1e-6, seconds = 20, print_level=0)
...
load_scaling_factor = 2.0       # Factor with which original base case load demand data should be scaled
